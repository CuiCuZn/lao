  ...
  assistant: {
    ...
    aideVideo: {
      consultation: {
        ...
        captureConfirm: '确认',
        captureSaved: '已上传图片',
        captureEmpty: '暂无已上传图片',
        captureHint: '拍照后确认即上传，可继续拍摄多张。',
        captureLimitReached: '最多支持上传 10 张照片。',
        captureUpload: '上传',
        captureUploading: '上传中...',
        captureUploadComplete: '上传已完成',
        captureUploadFailed: '照片上传失败，请稍后重试。',
        captureCaseUnavailable: '当前未获取到病例信息，暂时无法上传。',
        captureUploadResult: '上传结果',
        captureSavedSuccess: '照片已保存。',
        captureDeviceMissing: '未检测到侧面高拍仪',
        captureUnsupported: '当前浏览器不支持调用摄像头。',
        captureOpenFailed: '打开侧面高拍仪失败，请检查设备或浏览器权限。',
        captureNotReady: '摄像头画面未准备好，请稍后再试。',
        captureFailed: '拍照失败，请重试。',
        captureResolution: '分辨率',
        captureCurrentResolution: '当前：{resolution}',
        captureResolutionUnknown: '未知',
        captureResolutionChangeFailed: '分辨率切换失败，请尝试其他选项。',
        captureRotate: '旋转',
        captureRotateLeft: '左转',
        captureRotateRight: '右转',
        captureUploadImageTest: '上传图片',
        captureLocalImageOnly: '请选择图片文件。',
        captureLocalImageReadFailed: '读取图片失败，请重新选择。',
        captureUploaded: '已上传图片',
        captureUploadedEmpty: '暂无已上传图片',
        captureViewUploaded: '查看图片',
        captureRemoveUploaded: '删除图片',
        captureDeleteFailed: '删除图片失败，请稍后重试。',
        captureDeleteRefreshFailed: '图片已删除，但刷新检查内容失败，请重新打开后查看。',
        startRecognition: '开始识别',
        retryRecognition: '重新识别',
        confirmUpload: '确认上传',
        confirmUploadComplete: '确认上传完成',
        recognitionResult: '识别结果',
        recognitionReportTitle: '报告 {index}',
        recognitionItemName: '项目',
        recognitionResultValue: '结果',
        recognitionReferenceRange: '参考范围',
        recognitionUnit: '单位',
        recognitionAbnormalFlag: '异常标记',
        recognitionResultStatus: '结果状态',
        recognitionIsAbnormal: '异常',
        recognitionSubmitting: '正在提交识别',
        recognitionRetrying: '正在重新识别',
        recognitionWaiting: '等待识别结果',
        recognitionPending: '待识别',
        recognitionProcessing: '识别中',
        recognitionSuccess: '识别成功',
        recognitionFailedStatus: '识别失败',
        recognitionFailed: '识别失败，请重新识别。',
